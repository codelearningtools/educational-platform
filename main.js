async function init() {
    try {
        ...
        // Ensure sidebar works in both views
        const gradeFilter = document.getElementById('grade-filter');
        gradeFilter.addEventListener('change', () => {
            console.log('Grade selected:', gradeFilter.value); // Debug log
        ...
        subjectFilter.addEventListener('change', () => {
            console.log('Subject selected:', subjectFilter.value); // Debug log
        ...
        categoryFilter.addEventListener('change', () => {
            console.log('Category selected:', categoryFilter.value); // Debug log
...
function populateGradeFilter(manifest) {
    ...
    console.log('Grades available:', grades); // Debug log
    const gradeFilter = document.getElementById('grade-filter');
    gradeFilter.innerHTML = '<option value="">Select Grade</option>'; // Reset options
...
function onGradeChange(manifest) {
    ...
    if (grade) {
        ...
        console.log(`Subjects for grade ${grade}:`, subjects); // Debug log
...
function onSubjectChange(manifest) {
    ...
    if (subject) {
        ...
        console.log(`Categories for grade ${grade}, subject ${subject}:`, categories); // Debug log
...
function onCategoryChange(manifest) {
    ...
    if (category) {
        ...
        console.log(`Modules for grade ${grade}, subject ${subject}, category ${category}:`, modules); // Debug log
...
// Make updateSessionStats globally accessible
